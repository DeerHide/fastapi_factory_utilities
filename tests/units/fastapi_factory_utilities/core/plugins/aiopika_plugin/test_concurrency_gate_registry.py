...
from fastapi_factory_utilities.core.plugins.aiopika_plugin.concurrency import (
    ConcurrencyGate,
...
from fastapi_factory_utilities.core.plugins.aiopika_plugin.telemetry import NoOpConsumerTelemetry
