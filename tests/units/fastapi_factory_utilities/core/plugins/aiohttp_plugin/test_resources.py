...
from fastapi_factory_utilities.core.plugins.aiohttp_plugin.exceptions import AioHttpClientError
...
class TestAioHttpClientResourceBuildSslContext:
    ...
    def test_ssl_with_default_ca(self) -> None:
        ...
        with patch("fastapi_factory_utilities.core.plugins.aiohttp_plugin.resources.certifi") as mock_certifi:
...
class TestAioHttpClientResourceBuildTcpConnector:
    ...
    def test_build_tcp_connector(self) -> None:
        ...
        with patch(
            "fastapi_factory_utilities.core.plugins.aiohttp_plugin.resources.AioHttpClientResource.build_ssl_context"
        ) as mock_ssl:
            mock_ssl.return_value = False
            with patch(
                "fastapi_factory_utilities.core.plugins.aiohttp_plugin.resources.aiohttp.TCPConnector"
            ) as mock_connector:
...
class TestAioHttpClientResourceBuildTraceConfig:
    ...
    def test_build_trace_config_with_providers_and_instrumentation(self) -> None:
        ...
        with patch("fastapi_factory_utilities.core.plugins.aiohttp_plugin.resources.find_spec") as mock_find_spec:
...
class TestAioHttpClientResourceAcquireClientSession:
    ...
    async def test_acquire_client_session_success(self) -> None:
        ...
        with patch.object(AioHttpClientResource, "build_trace_config", return_value=None):
            with patch(
                "fastapi_factory_utilities.core.plugins.aiohttp_plugin.resources.aiohttp.ClientSession"
