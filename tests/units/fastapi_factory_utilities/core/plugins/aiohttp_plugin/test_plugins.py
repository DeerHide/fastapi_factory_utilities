...
from fastapi_factory_utilities.core.plugins.aiohttp_plugin.builder import AioHttpClientBuilder
from fastapi_factory_utilities.core.plugins.aiohttp_plugin.configs import HttpServiceDependencyConfig
from fastapi_factory_utilities.core.plugins.aiohttp_plugin.constants import STATE_PREFIX_KEY
from fastapi_factory_utilities.core.plugins.aiohttp_plugin.plugins import AioHttpClientPlugin
...
class TestAioHttpClientPlugin:
    ...
    def test_inheritance(self) -> None:
        ...
        with patch(
            "fastapi_factory_utilities.core.plugins.aiohttp_plugin.plugins.AioHttpClientBuilder"
...
class TestAioHttpClientPluginIntegration:
    ...
    async def test_plugin_with_real_builder(self) -> None:
        ...
        with patch(
            "fastapi_factory_utilities.core.plugins.aiohttp_plugin.builder.build_http_dependency_config"
        ) as mock_factory:
